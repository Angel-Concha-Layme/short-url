...
public class LinkController {
  ...
  public ResponseEntity<CompleteLinkDTO> createLink(
      @Valid @RequestBody CompleteLinkRequestDTO completeLinkRequestkDTO) {
    CompleteLinkDTO createdLink =
        linkService.createLink(completeLinkRequestkDTO, SecurityContext.getUserOrFail());
  ...
  public ResponseEntity<CompleteLinkDTO> getLinkById(@PathVariable Long id) {
    return ResponseEntity.ok(linkService.getLinkById(id, SecurityContext.getUserOrFail()));
  }
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasRole('ROLE_USER')")
  public ResponseEntity<CompleteLinkDTO> updateLink(
      @PathVariable Long id, @Valid @RequestBody CompleteLinkRequestDTO completeLinkRequestDTO) {
    return ResponseEntity.ok(
        linkService.updateLink(id, completeLinkRequestDTO, SecurityContext.getUserOrFail()));
  }
